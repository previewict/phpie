<?php
/**
 * Cli Component to work with PHP command line
 *
...
{
    /**
     * Print colorful string in PHP5 Command Line
     *
     * @ref https://gist.github.com/donatj/1315354
     * @var array
     */
    ...
    public static function coloredString($foreground_color, $args)
    {
