<?php
/**
 * Fedex Courier Component
 *
 * Fedex Web Service common class
 *
 * @url: https://www.fedex.com/us/developer/web-services/process.html?tab=tab1
 */
...
class Fedex
{
    ...
    function writeToLog($client)
    {
        ...
        fwrite($logfile, sprintf("\r%s:- %s", date("D M j G:i:s T Y"),
